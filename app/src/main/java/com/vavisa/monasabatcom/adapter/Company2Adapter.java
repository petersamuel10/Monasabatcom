...
public class Company2Adapter extends RecyclerView.Adapter<CompanyViewHolder> {

    ArrayList<Company> companies;
    Context mContext;

    public Company2Adapter() {
    ...
    public CompanyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_company2,null);
