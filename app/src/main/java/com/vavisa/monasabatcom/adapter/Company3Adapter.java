...
public class Company3Adapter extends RecyclerView.Adapter<CompanyViewHolder> {

    ArrayList<Company> companies;
    Context mContext;

    public Company3Adapter() {
    ...
    public CompanyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_company3,null);
